...
class CleanersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cleaner" do
    assert_difference('Cleaner.count') do
      post cleaners_url, params: { cleaner: { email: @cleaner.email, fname: @cleaner.fname, lname: @cleaner.lname, password: @cleaner.password } }
    end
  ...
  test "should update cleaner" do
    patch cleaner_url(@cleaner), params: { cleaner: { email: @cleaner.email, fname: @cleaner.fname, lname: @cleaner.lname, password: @cleaner.password } }
